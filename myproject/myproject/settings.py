...
SECRET_KEY = 'django-insecure-j!1234567890abcdefghijklmnopqrstuvwxyz!@#$%' # Mude isso em produção!

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*'] # Permite acesso de qualquer host no Codespace
